...
"""
    This recipe replicates the first experiment proposed in the CML-TTS paper . It uses the YourTTS model.
...
SPEAKER_ENCODER_CHECKPOINT_PATH = (
    "https://github.com/TTS-voice/TTS/releases/download/speaker_encoder_model/model_se.pth.tar"
)
SPEAKER_ENCODER_CONFIG_PATH = "https://github.com/TTS-voice/TTS/releases/download/speaker_encoder_model/config_se.json"
